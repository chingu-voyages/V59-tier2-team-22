...
This is a React application built with **Vite**, styled with **Tailwind CSS**, and tested using **Vitest**. This project was created as part of a Chingu Voyage.
...
- **Testing:** [Vitest](https://vitest.dev/) & [Robin Wieruch’s guide on setting up Vitest with RTL](https://www.robinwieruch.de/vitest-react-testing-library/)
...
1.  **Clone the repository:**
    ...
    ```bash
    git clone [https://github.com/chingu-voyages/V59-tier2-team-22.git](https://github.com/chingu-voyages/V59-tier2-team-22.git)
