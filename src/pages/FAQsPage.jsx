...
import { Link } from "react-router"; // Ensure your project uses 'react-router' or 'react-router-dom'
        ...
        {faqs.map((faq, index) => (
          ...
          >
            <button
              ...
              className="w-full px-6 py-5 flex items-center justify-between bg-white hover:bg-gray-50 transition-colors duration-200 text-left cursor-pointer"
            >
